...
_EXPORTS = {
    ...
    "TerrainBuildConfig": ("argusnet.world.procedural", "TerrainBuildConfig"),
    "TerrainProfile": ("argusnet.world.procedural", "TerrainProfile"),
    "ProceduralTerrainGrid": ("argusnet.world.procedural", "ProceduralTerrainGrid"),
    "LandscapeBuildConfig": ("argusnet.world.procedural", "LandscapeBuildConfig"),
    "LandscapeBuildResult": ("argusnet.world.procedural", "LandscapeBuildResult"),
    "build_terrain_layer": ("argusnet.world.procedural", "build_terrain_layer"),
    "build_landscape": ("argusnet.world.procedural", "build_landscape"),
    "LandCoverPatch": ("argusnet.world.procedural", "LandCoverPatch"),
