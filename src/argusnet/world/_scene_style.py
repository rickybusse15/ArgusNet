...
def default_style() -> dict[str, dict[str, object]]:
    return {
        ...
        "landcover-scrub": {
            "id": "landcover-scrub",
            "semantic_kind": "landcover",
            "color_rgba": hex_to_rgba("#B8B97D", 0.62),
            "opacity": 0.62,
            "elevation_mode": "terrain-draped",
            "draw_order": 14,
            "default_visibility": True,
        ...
        "landcover-wetland": {
            ...
            "semantic_kind": "water",
            "color_rgba": hex_to_rgba("#8FB9A5", 0.64),
            "opacity": 0.64,
            "elevation_mode": "terrain-draped",
            "draw_order": 15,
            "default_visibility": True,
        ...
        "landcover-rocky": {
            "id": "landcover-rocky",
            "semantic_kind": "landcover",
            "color_rgba": hex_to_rgba("#9F9A8D", 0.70),
            "opacity": 0.70,
            "elevation_mode": "terrain-draped",
            "draw_order": 16,
            "default_visibility": True,
        ...
        "landcover-snow": {
            "id": "landcover-snow",
            "semantic_kind": "landcover",
            "color_rgba": hex_to_rgba("#EDF2F5", 0.78),
            "opacity": 0.78,
            "elevation_mode": "terrain-draped",
            "draw_order": 17,
            "default_visibility": True,
        ...
        "landcover-road": {
            "id": "landcover-road",
            "semantic_kind": "roads",
            "color_rgba": hex_to_rgba("#B8B5AE", 0.92),
            "opacity": 0.92,
            "elevation_mode": "terrain-draped",
            "draw_order": 18,
            "default_visibility": True,
